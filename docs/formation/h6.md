...
<div class="good-reflex-box">
  <h3>Prompt générique d'audit d'accessibilité & d'inclusivité</h3>
  <p><em>« Joue le rôle d'un expert en accessibilité (RGAA) et en communication inclusive. Analyse le texte suivant et propose une version révisée qui :<br>
  1. Simplifie les phrases (niveau B1 max) ;<br>
  2. Élimine tout stéréotype ou biais implicite ;<br>
  3. Structure la réponse avec des titres et des listes à puces. »</em></p>
</div>
