...
!!! tip "Dans la vraie vie"
    Quand vous demandez à l’IA de simplifier un texte, précisez le public.
    
    Exemple :
    
    - nouveaux salariés ;
    - clients non spécialistes ;
    - personnes peu à l’aise avec le numérique ;
    - personnes avec troubles DYS ;
    - public FLE.
    
    Un texte simple n’est pas un texte pauvre. C’est un texte plus facile à comprendre.
...
**Prochaine séance (H7)** : [Éthique, IA Act, encadrement juridique et biais →](h7.md)
