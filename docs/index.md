...
Bienvenue dans votre espace de ressources dédié à l’IA générative et à la préparation de la certification **RS6776**.

Ce wiki complète les séances de formation.  
Il vous aide à revoir les notions clés, retrouver les méthodes importantes et appliquer l’IA dans des situations professionnelles concrètes.
...
| Rubrique | Utilité |
|---|---|
| **Certification RS6776** | Comprendre la certification, les compétences visées et l’évaluation d’entrée |
| **Formation** | Revoir les séances H0 à H7 dans l’ordre |
| **Ressources pratiques** | Accéder aux cas métiers, templates, fiches outils, sources et articles |
| **Glossaire** | Retrouver rapidement les méthodes et termes importants |
