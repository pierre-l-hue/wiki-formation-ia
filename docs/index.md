...
| Exercice | Sujet | Séance liée |
|---|---|---|
| 1 | Stratégie d'implémentation IA | H2 |
| 2 | Prompting rédactionnel + visuel | H3, H4 |
| 3 | Confidentialité et données sensibles | H5 |
| 4 | Accessibilité et inclusion | H6 |
| 5 | Simplification et vulgarisation de contenus | H6 |
| 6 | Éthique et biais dans les contenus IA | H7 |
